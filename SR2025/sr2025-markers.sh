...
april_vision marker_generator SINGLE \
    ...
    --description_format "Student Robotics - High-rise - #{marker_id}" --all_filename "highrise_markers.pdf"
april_vision marker_generator TILE \
    --num_rows 2 --num_columns 2 --repeat 4 --page_size A3 \
    --left_margin 20 --top_margin 20 --row_padding 40 --column_padding 40 \
    --marker_size 80 --range 195-199 \
    --description_format "Student Robotics - High-rise - #{marker_id}" --all_filename "highrise_markers_a3.pdf"

echo "Collate all the non-A3 marker sheets into a single PDF"
# pdfunite arena_markers.pdf green_pallets.pdf orange_pallets.pdf magenta_pallets.pdf yellow_pallets.pdf highrise_markers.pdf SR2025_markers_a4.pdf
echo "Collate the A3 marker sheets with the arena markers into a single PDF"
# pdfunite arena_markers.pdf green_pallets_a3.pdf orange_pallets_a3.pdf magenta_pallets_a3.pdf yellow_pallets_a3.pdf highrise_markers_a3.pdf SR2025_markers.pdf
